...
void
put_to_memory_rec_pool(struct memory_rec *oldaf)
{
...
/* erase ch's memory */
void
clear_memory(struct char_data *ch)
{
...
int
update_memory_list(struct char_data *victim)
{
...
void
enforce_position(struct char_data *ch, int new_pos)
{
