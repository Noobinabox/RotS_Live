...
int movement_loss[] =
    {/* movement cost with a good load BTW. min. is 3/4 .. 2->1 4->2.5 6->4 10 ->7times smaller */
     2,  /* Inside     */
     3,  /* City       */
     4,  /* Field      */
     7,  /* Forest     */
...
char *where[] = {
    ...
    "<worn on back>         ", "<worn on belt>         ", "<worn on belt>         ",
    "<worn on belt>         ", "<wielded two-handed>   ",
};

char *beornwhere[] = {
    "<used as light>        ", "<worn on paw>          ", "<worn on paw>          ",
    "<worn around neck>     ", "<worn around neck>     ", "<worn on body>         ",
    "<worn on head>         ", "<worn on hindlegs>     ", "<worn on hindfeet>     ",
    "<worn on claws>        ", "<worn on forlegs>      ", "<worn as shield>       ",
    "<worn about body>      ", "<worn about waist>     ", "<worn around wrist>    ",
    "<worn around wrist>    ", "<wielded>              ", "<held>                 ",
    "<worn on back>         ", "<worn on belt>         ", "<worn on belt>         ",
    "<worn on belt>         ", "<wielded two-handed>   ",
...
sh_int square_root[171] = {
    0,    100,  141,  173,  200,  223,  244,  264,  282,  300,  316,  331,  346,  360,  374,  387,
    400,  412,  424,  435,  447,  458,  469,  479,  489,  500,  509,  519,  529,  538,  547,  556,
    565,  574,  583,  591,  600,  608,  616,  624,  632,  640,  648,  655,  663,  670,  678,  685,
    692,  700,  707,  714,  721,  728,  734,  741,  748,  754,  761,  768,  774,  781,  787,  793,
    800,  806,  812,  818,  824,  830,  836,  842,  848,  854,  860,  866,  871,  877,  883,  888,
    894,  900,  905,  911,  916,  921,  927,  932,  938,  943,  948,  953,  959,  964,  969,  974,
    979,  984,  989,  994,  1000, 1004, 1009, 1014, 1019, 1024, 1029, 1034, 1039, 1044, 1048, 1053,
    1058, 1063, 1067, 1072, 1077, 1081, 1086, 1090, 1095, 1100, 1104, 1109, 1113, 1118, 1122, 1126,
    1131, 1135, 1140, 1144, 1148, 1153, 1157, 1161, 1166, 1170, 1174, 1178, 1183, 1187, 1191, 1195,
    1200, 1204, 1208, 1212, 1216, 1220, 1224, 1228, 1232, 1236, 1240, 1244, 1248, 1252, 1256, 1260,
    1264, 1268, 1272, 1276, 1280, 1284, 1288, 1292, 1296, 1300, 1303,
};
