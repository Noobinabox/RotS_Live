...
void assign_command_pointers(void)
{
    ...
    COMMANDO(240, POSITION_FIGHTING, do_windblast, 0, TRUE, 0,
        TAR_IGNORE, TAR_IGNORE, 0);
    COMMANDO(241, POSITION_FIGHTING, do_smash, 10, TRUE, 0,
        TAR_FIGHT_VICT | TAR_CHAR_ROOM, TAR_IGNORE, CMD_MASK_MOVE_PENALTY);
    COMMANDO(242, POSITION_FIGHTING, do_frenzy, 25, TRUE, 0,
        TAR_NONE_OK, TAR_IGNORE, CMD_MASK_MOVE_PENALTY);
    COMMANDO(243, POSITION_FIGHTING, do_stomp, 20, TRUE, 0,
        TAR_NONE_OK, TAR_IGNORE, CMD_MASK_MOVE_PENALTY);
    COMMANDO(244, POSITION_FIGHTING, do_cleave, 15, TRUE, 0,
        TAR_NONE_OK, TAR_IGNORE, CMD_MASK_MOVE_PENALTY);
    COMMANDO(245, POSITION_FIGHTING, do_overrun, 30, TRUE, 0,
