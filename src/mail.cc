...
void
index_mail(char *raw_name_to_index, long pos)
{
...
char *
read_delete(char *recipient, char *recipient_formatted, int is_good)
...
void
postmaster_send_mail(struct char_data *ch, int cmd, char *arg, char_data *host)
{
...
void
postmaster_check_mail(struct char_data *ch, int cmd, char *arg, char_data *host)
{
  struct char_data *mailman;
  char buf[200], recipient[100], *tmp;
...
void
postmaster_receive_mail(struct char_data *ch, int cmd, char *arg, char_data *host)
{
  struct char_data *mailman;
  char	buf[200], recipient[100], *tmp;
