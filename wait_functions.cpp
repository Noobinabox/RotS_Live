...
//============================================================================
void WaitList::wait_state_brief(char_data* character, int wait_time, int command, int sub_command,
...
//============================================================================
void WaitList::wait_state_full(char_data* character, int wait_time, int command, int sub_command,
...
*********************************************************************/
WaitList* WaitList::m_pInstance(NULL);
bool WaitList::m_bDestroyed(false);
